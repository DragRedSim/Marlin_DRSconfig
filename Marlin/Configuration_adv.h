...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 30, Y_BED_SIZE / 2 }, { X_BED_SIZE - 30, Y_BED_SIZE / 2 } } //use bed size, moves to a relatively clear Y axis value. 
...
#define ASSISTED_TRAMMING
  ...
  // Define positions for 3-9 probe points. Used for G35 command.
 ...
 */
  ...
  #define PROBE_PT_1_X 30 //customised
  #define PROBE_PT_1_Y 30
  #define PROBE_PT_2_X (X_BED_SIZE - PROBE_PT_1_X)   // mirror PT_1_X across the X axis as inset
  #define PROBE_PT_2_Y PROBE_PT_1_Y                  // match PT_1_Y value
  #define PROBE_PT_3_X X_CENTER                      // take middle of bed; this is halfway across, equivalent via mirror
  #define PROBE_PT_3_Y (Y_BED_SIZE - PROBE_PT_1_Y)   // inset Y value by same amount on other side
#endif
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CONFIG_MENU_ITEM_1_DESC "Level Steppers"
  #define CONFIG_MENU_ITEM_1_GCODE "G34 T0.01"
